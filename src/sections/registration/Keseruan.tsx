    ...
    <section className="bg-[url(/registration/bg-keseruan.png)] bg-cover min-h-[130vh] bg-center mt-10 py-10 flex flex-col items-center">
      ...
      <div className="w-full flex items-center justify-center">
        {fullMode ? (
          ...
          <div onClick={() => {setSelectedEvent(events[4]); setShowModal(true)}} className="border-green-300 border-2 shadow backdrop-blur-3xl rounded-lg items-center flex flex-col justify-between gap-4 h-[250px] pt-10 pb-10 px-5 mx-10">
            <div className="h-5/6 w-full flex items-center justify-center object-contain">
